...
public class EmployeeServiceImpl implements IEmployeeService {
	...
	public boolean AddEmployee(HashMap<String,String> emp)  {
		...
		String address=(String) emp.get("address");
		 ...
		 doj=d.parse((String) emp.get("doj"));
			...
			System.out.println("Date is not in proper format. Kindly Enter date in dd-mm-yyyy format");
			return false;
		}
	...
	public boolean ModifyEmployee(HashMap emp) {
		Employee e=EmployeeDaoImplForList.getDaoReference().getEmployeeByEmailId((String)emp.get("emailId"));
		...
		return EmployeeDaoImplForList.getDaoReference().ModifyEmployee(e);	
		}

	@Override
	public boolean RemoveEmployee(String key, String value) {
		return	EmployeeDaoImplForList.getDaoReference().RemoveEmployee(key,value);
	...
	public  HashMap<String, String> getRolesList() {
		...
		ArrayList<Role> rol=EmployeeDaoImplForList.getDaoReference().getRoleList();
		if(rol==null)
			return null;
	...
	public  HashMap<String, String> getDepartmentList() {
		...
		ArrayList<Department> dep=EmployeeDaoImplForList.getDaoReference().getDepartmentList();
		if(dep==null)
			return null;
	...
	public  HashMap<String, String> getProjectList(String dept) {
		...
		ArrayList<Project> proj=EmployeeDaoImplForList.getDaoReference().getProjectList(dept);
