...
public class EmployeeCreationSystem_HashMap{
...
emp=new HashMap<EmpKey,Employee>();
...
System.out.println("Search hash key="+ek.hashCode());
try {
...
public static void display(){
	...
	{
		System.out.println("hash="+o.getKey().hashCode()+","+o.getKey() +"->"+ o.getValue());
	}
}
