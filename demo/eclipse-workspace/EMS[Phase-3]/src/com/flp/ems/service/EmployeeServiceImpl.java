...
public class EmployeeServiceImpl implements IEmployeeService {
	...
	public boolean AddEmployee(HashMap<String,String> emp)  {
		...
		EmployeeDaoImplForDB dao=EmployeeDaoImplForDB.getDaoReference();
	...
	public HashMap<String,String> getEmployeeByEmailId(String emailId){
		Employee e=EmployeeDaoImplForDB.getDaoReference().getEmployeeByEmailId(emailId);
	...
	public boolean ModifyEmployee(HashMap emp) {
		Employee e=EmployeeDaoImplForDB.getDaoReference().getEmployeeByEmailId((String)emp.get("emailId"));
		...
		return EmployeeDaoImplForDB.getDaoReference().ModifyEmployee(e);	
		}
	...
	public  HashMap<String, String> getRolesList() {
		...
		ArrayList<Role> rol=EmployeeDaoImplForDB.getDaoReference().getRoleList();
		if(rol==null)
			return null;
	...
	public  HashMap<String, String> getDepartmentList() {
		...
		ArrayList<Department> dep=EmployeeDaoImplForDB.getDaoReference().getDepartmentList();
		if(dep==null)
			return null;
	...
	public  HashMap<String, String> getProjectList(String dept) {
		...
		ArrayList<Project> proj=EmployeeDaoImplForDB.getDaoReference().getProjectList(dept);
